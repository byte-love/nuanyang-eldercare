  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>暖阳颐养管理平台</h2>
        <p>
          面向机构养老场景的一体化管理平台，覆盖入住办理、护理计划、健康评估、家属端服务与智能咨询等能力，助力提升日常运营效率与服务质量。
        </p>
        <p>
          <b>当前版本:</b> <span>v{{ version }}</span>
        </p>
        <p>
          <el-tag type="success">暖阳颐养</el-tag>
        </p>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 项目：暖阳颐养智慧养老管理平台
            </p>
            <p>
              <i class="el-icon-user-solid"></i> 作者：<el-link
                href="https://github.com/byte-love"
                target="_blank"
                >byte-love</el-link
              >
            </p>
