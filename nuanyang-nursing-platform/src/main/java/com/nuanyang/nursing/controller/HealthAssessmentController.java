...
import com.nuanyang.common.utils.PDFUtil;
import com.nuanyang.nursing.dto.HealthAssessmentDto;
import com.nuanyang.oss.client.OSSAliyunFileStorageService;
...
public class HealthAssessmentController extends BaseController
{
    ...
    public AjaxResult uploadFile(MultipartFile file,String idCardNo) throws Exception
    {
        try
        {
            ...
            //存储到redis中
            redisTemplate.opsForHash().put("healthVoReport", idCardNo, content);
...
//            ajax.put("newFileName", FileUtils.getName(fileName));
    ...
    @PostMapping
    public AjaxResult add(@RequestBody HealthAssessmentDto healthAssessmentDto)
    {
