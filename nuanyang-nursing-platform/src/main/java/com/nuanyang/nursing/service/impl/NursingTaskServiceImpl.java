package com.nuanyang.nursing.service.impl;
...
import com.nuanyang.common.utils.IdCardUtils;
import com.nuanyang.common.utils.StringUtils;
import com.nuanyang.nursing.domain.*;
import com.nuanyang.nursing.dto.NursingTaskDto;
import com.nuanyang.nursing.dto.TaskDto;
import com.nuanyang.nursing.mapper.ElderMapper;
import com.nuanyang.nursing.mapper.NursingElderMapper;
import com.nuanyang.nursing.mapper.NursingTaskMapper;
import com.nuanyang.nursing.service.*;
import com.nuanyang.nursing.vo.NursingNameVo;
import com.nuanyang.nursing.vo.NursingPlanVo;
import com.nuanyang.nursing.vo.NursingProjectPlanVo;
...
public class NursingTaskServiceImpl extends ServiceImpl<NursingTaskMapper, NursingTask> implements INursingTaskService {
    ...
    public NursingTaskVo selectNursingTaskById(Long id) {
        ...
        nursingTaskVo.setAge(IdCardUtils.getAge(elder.getIdCardNo()));
    ...
    public TableDataInfo selectNursingTaskList(NursingTaskDto nursingTaskDto) {
        ...
        //通过nursing_id获取老人对应的护理员信息    // 103,104,106,105
