...
import com.nuanyang.common.constant.HttpStatus;
import com.nuanyang.common.core.page.TableDataInfo;
import com.nuanyang.nursing.vo.NursingProjectVo;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import com.nuanyang.nursing.mapper.NursingProjectMapper;
import com.nuanyang.nursing.domain.NursingProject;
import com.nuanyang.nursing.service.INursingProjectService;
...
//        nursingProject.setUpdateTime(DateUtils.getNowDate());
     ...
     */
    @Override
    public TableDataInfo selectPage(Integer pageNum, Integer pageSize,String name) {

        //分页查询数据
        IPage page = new Page(pageNum,pageSize);
        page = page(page, Wrappers.<NursingProject>lambdaQuery()
